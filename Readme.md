...
# Configuration Script – MIR-IR1001 - Rev. A

This **Configuration** script is designed for the **MIR-IR1001** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – MIR-IR1001 Rev. A

Este script de **Configuration** está diseñado para el modelo **MIR-IR1001** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
